...
- Fix AirPrint cross-subnet on iPhone: use HA host's UUID as Avahi hostname
  - Container's default hostname doesn't resolve cross-subnet (router mDNS reflection limitation)
