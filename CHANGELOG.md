...
- Harden CUPS access control: admin panel requires password, printing open to all private networks
  ...
  - Replaced `@LOCAL` with explicit RFC1918 ranges to support cross-subnet printing
...
- Open CUPS access to all network clients (fixes cross-subnet "Forbidden" errors)
