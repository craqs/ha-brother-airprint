...
- Fix AirPrint cross-subnet on iPhone: static Avahi service file with custom hostname
  - Static service file advertises printer under `homeassistant.local` (resolvable from all subnets)
